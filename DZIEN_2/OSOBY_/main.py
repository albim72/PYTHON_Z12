...
print(f"bmi ciała wynosi: {os2.bmi():.2f}, opis: {os2.opis_bmi()}")
print(f"zapotrzebowanie energetyczne: {os2.policz_ppm('m')} kcal")
...
print(f"zapotrzebowanie energetyczne: {st3.policz_ppm('m')} kcal")
